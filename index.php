<?php include('src/header.php');?>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo $background_img; ?>');background-size:<?php echo $background_size; ?>;">
			<div class="wrap-login100">
				<?php if($_SESSION['realname'] AND $_SESSION['password']){?>
					<form action="" method="POST" class="login100-form validate-form">
						...
						<b>Your nick:</b> <?php echo $_SESSION['realname'];?><br>
				...
				<?php }else{;?>
					<form action="" method="POST" class="login100-form validate-form">
						...
						<?php if(count($error) > 0){error_reporting(-1);
